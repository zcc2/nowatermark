...
import com.zcc.nowatermark.base.readapter.listener.OnItemClickListener;
import com.zcc.nowatermark.base.readapter.listener.OnItemLongClickListener;
...
public abstract class BaseRecyclerViewAdapter<T, VH extends BaseRecyclerViewAdapter.SparseArrayViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public static class SparseArrayViewHolder extends RecyclerView.ViewHolder {
        ...
        public SparseArrayViewHolder setImage(int viewId, String imageRes, Context context) {
            ImageView view = getView(viewId);
//            view.setImageResource(imageResId);
            Glide.with(context).load(imageRes).into(view);
//            ImageLoader.getInstance().loadImage(imageRes, view);
            return SparseArrayViewHolder.this;
        }
