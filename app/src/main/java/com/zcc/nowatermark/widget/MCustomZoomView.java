...
public class MCustomZoomView extends View {
    ...
    /*边角线长度*/private float mCornerLength = 20f * mDensity;
    ...
    /*是否绘制坐标点*/private boolean mIsDrawPonit=true;
    ...
    public MCustomZoomView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
...
//            }
    ...
    private void toolDrawPoint(Canvas canvas) {
        ...
        x =mRect_FourCorner_coordinate[0][0];
...
//                , mTextPaint);
//
        width =mRect_FourCorner_coordinate[2][0]-x;
        canvas.restore();
...
//                , mTextPaint);
        height =mRect_FourCorner_coordinate[1][1]-y;
        canvas.restore();
    }
